...
//        }
        ...
        if (directionToEnemyStrength.isEmpty()) {
            return new NullPiece();
        }

        Direction directionMinStrength = Collections.min(directionToEnemyStrength.entrySet(), (entry1, entry2) -> entry1.getValue() - entry2.getValue()).getKey();
