...
//        GridWorldDomain gridWorldDomain = new GridWorldDomain(10, 10);
//        OOSADomain domain = gridWorldDomain.generateDomain();
//
//        GridWorldState s = new GridWorldState(new GridAgent(0, 0), new GridLocation(1, 2, "loc0"));
//
//        //define joint reward function and termination conditions for this game
//
////        World w = new World(gridWorldDomain, rf, tf, s);
////
////        GameEpisode ga = null;
////        for (int i = 0; i < 3; i++) {
////            ga = w.runGame();
